# CRS V13.1 current release

Baseline: V11.1 RC workspace / embedded commit `5b954ffaa16497e31e4805f29672500a167598de`.

Current continuation baseline: V13 workspace with recipe retention, automatic Waitress/PLC-worker deployment, restore persistence, PLC-job finalization, responsive header, and guided parameter setup patches applied.

V13.1 adds a persistent seven-step Configuration Center workflow, standard/advanced separation, readiness-derived progress, and preview-first parameter-template creation. See `project_docs/configuration_ux_redesign/`.
...
- final target-workstation authenticated visual/accessibility sign-off;
