# CRS V13.1 agreement compliance matrix
...
| Guided configuration journey | Implemented | Seven validated steps with persistent progress and Engineering Tools separation |
| Parameter template preview | Implemented | Configured-array rows are validated and previewed before atomic creation |
